    ...
    public function fix_js_StartUp_DragAndDrop(&$substr)  {
        ...
        if ($pos = strpos($substr, $search)) {
            $insert = "\n"
                ...
                ."	if (div) {\n"
                ."		var t = L[0].GetB() - getOffset(div, 'Height') - 2;\n"
                ."		var l = L[0].GetL() + 2;\n"
                ."		var l = Math.max(l, (Cds[0].GetL() - getOffset(div, 'Width') - 10));\n"
                ."		setOffset(div, 'Top', t);\n"
                ."		setOffset(div, 'Left', l);\n"
                ...
                ."		var t = L[x].GetB() - getOffset(div, 'Height') - 2;\n"
                ."		var l = L[x].GetR() - getOffset(div, 'Width')  - 2;\n"
                ."		var x = Cds.length - 1;\n"
                ."		var l = Math.min(l, Cds[x].GetR() + 10);\n"
                ."		setOffset(div, 'Top', t);\n"
                ."		setOffset(div, 'Left', l);\n"
