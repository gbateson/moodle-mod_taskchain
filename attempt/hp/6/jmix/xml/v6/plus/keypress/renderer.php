...
/**
 * mod/taskchain/attempt/hp/6/jmix/xml/v6/plus/keypress/renderer.php
 *
 * @package    mod
...
/**
 * mod_taskchain_attempt_hp_6_jmix_xml_v6_plus_keypress_renderer
 *
 * @copyright  2010 Gordon Bateson (gordon.bateson@gmail.com)
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @since      Moodle 2.0
 ...
 * @subpackage taskchain
 */
class mod_taskchain_attempt_hp_6_jmix_xml_v6_plus_keypress_renderer extends mod_taskchain_attempt_hp_6_jmix_xml_v6_plus_renderer {
    ...
    public function fix_bodycontent() {
        ...
        $this->bodycontent .= "\n"
            ...
            ."function taskchain_jmix_get_unicode(e) {\n"
            ...
            ."function taskchain_jmix_onkeypress(e) {\n"
            ."	var unicode = taskchain_jmix_get_unicode(e);\n"
            ."	if (unicode) {\n"
            ...
            ."				if (window.taskchain_jmix_whitespace) {\n"
            ."					l += LastCard.GetW();\n"
            ."				}\n"
            ."				var t = LastCard.GetT();\n"
            ."			} else {\n"
            ...
            ."			window.taskchain_jmix_whitespace = false;\n"
            ."			window.taskchain_jmix_checkresults = true;\n"
            ...
            ."			window.taskchain_jmix_whitespace = false;\n"
            ."			if (window.taskchain_jmix_checkresults) {\n"
            ."				CheckResults(0);\n"
            ."				window.taskchain_jmix_checkresults = false;\n"
            ."				return false;\n"
            ."			}\n"
            ."		}\n"
            ...
            ."		// 32=Space\n"
            ."		if (unicode==32) {\n"
            ."			window.taskchain_jmix_whitespace = true;\n"
            ."			window.taskchain_jmix_checkresults = true;\n"
            ."			return false;\n"
            ."		}\n"
            ...
            ."	return true;\n"
            ."}\n"
            ."document.onkeypress = taskchain_jmix_onkeypress;\n"

            ."function taskchain_jmix_onkeydown(e) {\n"
            ."	var unicode = taskchain_jmix_get_unicode(e);\n"
            ."	if (unicode) {\n"
            ...
            ."		// 27=Esc\n"
            ."		if (unicode==27) {\n"
            ."			taskchain_jmix_restart();\n"
            ."			return false;\n"
            ."		}\n"
            ."	}\n"
            ."	return true;\n"
            ."}\n"
            ."document.onkeydown = taskchain_jmix_onkeydown;\n"

            ."function taskchain_jmix_restart() {\n"
