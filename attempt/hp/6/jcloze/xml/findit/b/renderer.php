...
/**
 * mod/taskchain/attempt/hp/6/jcloze/xml/findit/b/renderer.php
 *
 * @package    mod
...
require_once($CFG->dirroot.'/mod/taskchain/attempt/hp/6/jcloze/xml/findit/renderer.php');

/**
 * mod_taskchain_attempt_hp_6_jcloze_xml_findit_b_renderer
 *
 * @copyright  2010 Gordon Bateson (gordon.bateson@gmail.com)
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @since      Moodle 2.0
 ...
 * @subpackage taskchain
 */
class mod_taskchain_attempt_hp_6_jcloze_xml_findit_b_renderer extends mod_taskchain_attempt_hp_6_jcloze_xml_findit_renderer {
    ...
    public function __construct(moodle_page $page, $target)  {
        ...
        array_unshift($this->templatesfolders, 'mod/taskchain/attempt/hp/6/jcloze/xml/findit/b/templates');

        // replace standard jcloze.js with findit.b.js
        $this->javascripts = preg_grep('/jcloze.js/', $this->javascripts, PREG_GREP_INVERT);
        array_push($this->javascripts, 'mod/taskchain/attempt/hp/6/jcloze/findit.b.js');
    }
