    ...
    public function fix_js_SetUpQuestions(&$str, $start, $length) {
        ...
        if ($dots) {
            ...
            $replace = "\n"
                ...
                ."\n"
                .'		// remove bottom border (override class="TaskQuestion")'."\n"
                ."		if (QArray[i]) {\n"
...
// utility function to search and replace and, if required, call the fix_js_xxx() method of the parent class
    ...
    public function expand_HeaderCode() {
        ...
        $headercode = ''
            .'<style type="text/css">'."\n"
            .'li.TaskQuestion div.JumbledItems {'."\n"
            .'	margin-bottom: 1.0em;'."\n"
            .'	padding-right: 8px;'."\n"
            .'}'."\n"
            .'li.TaskQuestion div.JumbledItems span.JumbledItem {'."\n"
            .'	padding: 2px 6px;'."\n"
            .'	margin: 0px 8px;'."\n"
            .'	border: 2px solid #ff9999;'."\n"
            .'	background-color: #fff9f9;'."\n"
            .'}'."\n"
            .'li.TaskQuestion span.JumbledItemsPrefix {'."\n"
            .'	font-size: 1.1em;'."\n"
            .'}'."\n"
            .'li.TaskQuestion span.DropArea {'."\n"
            .'	padding: 2px 8px;'."\n"
            .'	border: 2px solid #99ff99;'."\n"
            .'	background-color: #f9fff9;'."\n"
            .'}'."\n"
            .'li.TaskQuestion span.DropArea span.JumbledItem {'."\n"
            .'	padding: 0px 4px;'."\n"
            .'}'."\n"
            .'li.TaskQuestion span.JumbledItemsSuffix {'."\n"
            .'	font-size: 1.1em;'."\n"
            .'}'."\n"
            .'</style>'."\n"
            .$headercode
