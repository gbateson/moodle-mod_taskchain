...
/**
 * mod/taskchain/attempt/hp/6/jmatch/html/sort/renderer.php
 *
 * @package    mod
...
/**
 * mod_taskchain_attempt_hp_6_jmatch_html_sort_renderer
 *
 * @copyright  2010 Gordon Bateson (gordon.bateson@gmail.com)
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @since      Moodle 2.0
 ...
 * @subpackage taskchain
 */
class mod_taskchain_attempt_hp_6_jmatch_html_sort_renderer extends mod_taskchain_attempt_hp_6_jmatch_html_renderer {
    ...
    public function fix_headcontent()  {
        ...
        $this->fix_headcontent_rottmeier('jsort');
    }
