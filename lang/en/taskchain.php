...
$string['columnlist'] = 'Settings group {$a}';
$string['columnlistid'] = 'Settings groups';
$string['columnlistid_help'] = 'This menu allows you to select which group of settings are shown on this page';
$string['columnlistschain'] = 'All settings groups for chains';
$string['columnlistschains'] = 'Settings groups for chains';
$string['columnliststask'] = 'All settings groups for tasks';
$string['columnliststasks'] = 'Settings groups for tasks';
...
$string['chainx'] = 'Chain {$a}';
$string['taskx'] = 'Task {$a}';
$string['selectshdr'] = 'Select records';
$string['defaultshdr'] = 'Default values';
$string['labelshdr'] = 'Column headings';