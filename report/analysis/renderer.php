...
/**
 * mod/taskchain/report/analysis/renderer.php
 *
 * @package    mod
...
/**
 * mod_taskchain_report_analysis_renderer
 *
 * @copyright  2010 Gordon Bateson (gordon.bateson@gmail.com)
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @since      Moodle 2.0
 ...
 * @subpackage taskchain
 */
class mod_taskchain_report_analysis_renderer extends mod_taskchain_report_renderer {
                ...
                foreach ($row->$column as $response) {
                    ...
                    foreach($fields as $field) {
                        ...
                        foreach($values as $value) {
                            // $value should be an integer (taskchain_strings.id or count)
                            if (is_numeric($value)) {
                                $f[$field]['count']++;
     ...
     * @todo Finish documenting this function
     */
    public function get_hi_lo_scores(&$attempts)  {
     ...
     */
    public function usort_statistics($a, $b)  {
