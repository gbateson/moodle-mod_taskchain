...
/**
 * This file contains an event for when a taskchain activity is viewed.
 *
...
class course_module_viewed extends \core\event\course_module_viewed {
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'taskchain', 'view', $url->out(), $this->objectid, $this->context->instanceid);
    }
}
