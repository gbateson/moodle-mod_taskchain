...
/**
 * mod/taskchain/classes/event/attempt_started.php
 *
...
abstract class base extends \core\event\base {
    ...
    public static function get_name() {
        return get_string(self::get_event_string_name(), 'mod_taskchain');
    }
    ...
    public function get_description() {
        ...
        $a = (object)array('courseid'      => $this->courseid,
                           ...
                           'other'         => $this->other);
        return get_string(self::get_event_string_name('_description'), 'mod_taskchain', $a);
    }
    ...
    public static function get_explanation() {
        return get_string(self::get_event_string_name('_explanation'), 'mod_taskchain');
    }
    ...
    public function get_url() {
        ...
        return new \moodle_url('/mod/taskchain/view.php', $params);
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $url = preg_replace('/^.*\/mod\/taskchain\//', '', $this->get_url());
        return array($this->courseid, 'taskchain', $name, $url, $this->objectid, $this->contextinstanceid);
    }
   ...
   /**
    ...
    protected function get_legacy_records() {
        return array(array('course',    'course',         $this->courseid),
                     ...
                     array('taskchain', 'taskchain',      $this->objectid));
    }
