...
class taskchain_form_helper_task extends taskchain_form_helper_record {
    ...
    protected function add_field_outputformat($field) {
        ...
        $options = $this->TC->available_outputformats_list($sourcetype);
    ...
    protected function add_field_title($field) {
        ...
        $elements = array();
        $elements[] = $this->mform->createElement('select',   $name_source,  '', $this->TC->available_titles_list());
    ...
    protected function add_field_stopbutton($field) {
        ...
        $elements[] = $this->mform->createElement('select', $name_type, '', $this->TC->available_stopbuttontypes_list());
    ...
    protected function add_field_studentfeedback($field) {
        ...
        $elements = array();
        $elements[] = $this->mform->createElement('select', $name, '', $this->TC->available_feedbacks_list());
    ...
    protected function add_field_delay3($field) {
        $before = array('options' => $this->TC->available_delay3s_list());
    ...
    protected function format_fieldvalue_outputformat($field, $value) {
        ...
        $list = $this->TC->available_outputformats_list($type);
